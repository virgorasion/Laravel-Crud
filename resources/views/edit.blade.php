				...
				<form class="form-horizontal" action="/edit/{{$task['id']}}/update" method="POST">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="Title" value="{{$task['title']}}" name="title" placeholder="Title" id="demo-hor-inputemail" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="demo-hor-inputpass">body</label>
							<div class="col-sm-9">
								<input type="body" value="{{$task['body']}}" name="body" placeholder="body" id="demo-hor-inputpass" class="form-control">
							</div>
						</div>
					</div>
